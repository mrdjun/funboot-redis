  ...
  $.fn.tableExport = function (options) {
      var defaults = {
        ...
        jspdf: {
          ...
          autotable: {
            styles: {
              ...
              fontStyle:   'normal',      // normal, bold, italic, bolditalic or 'inherit' to use css fonts-weight and fonst-style from html table
        ...
        pdfmake: {
          ...
          docDefinition: {
            ...
            defaultStyle: {
              font: 'Roboto'              // default is 'Roboto', for arabic fonts set this option to 'Mirza' and include mirza_fonts.js
            }
          },
          fonts: {}
        },
      ...
      */
      ...
      function getCellStyles (cell) {
        ...
        var fs = getStyle(cell, 'fonts-style');
        var f  = '';
        if ( a == 'start' )
